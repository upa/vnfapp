...
/* Process Global to Private */
void *process_right_to_left(void * param)
{
...
/* Process Private to Global */
void *process_left_to_right(void *param)
{
	struct vnfapp *va = (struct vnfapp *)param;
...
main (int argc, char ** argv)
{
	...
	for (n = 0; n < rq; n++) {
		...
		pthread_create (&va->tid, NULL, process_right_to_left, va);
	}
	...
	for (n = 0; n < lq; n++) {
		...
		pthread_create (&va->tid, NULL, process_left_to_right, va);
	}
